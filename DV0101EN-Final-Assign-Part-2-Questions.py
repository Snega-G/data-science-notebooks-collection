...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
            ...
            style={'width': '50%', 'padding': '3px', 'font-size': '18px', 'text-align-last': 'center'}
        )),
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(avr_vdata,
                      x='Vehicle_Type',
                      y='Automobile_Sales',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(selected_year)))
